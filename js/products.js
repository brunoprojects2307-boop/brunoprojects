...
const WHATSAPP_CONFIG = {
  phoneNumber: window.WHATSAPP_CONFIG?.phoneNumber || "919953313731",
...
async function loadCatalogData() {
  const backendUrl = "https://brunobackend-tfg7.onrender.com/api";
  ...
  try {
    ...
    console.warn("Backend API call failed, falling back to direct Supabase read:", err.message);
