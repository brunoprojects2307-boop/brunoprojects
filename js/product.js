    ...
    <div class="product-detail-grid">
      <div class="product-gallery">
        <div class="main-image-wrapper">
          <img src="${product.images[0]}" alt="${product.name}" class="main-image" id="mainImage" style="${isOutOfStock ? 'opacity: 0.5;' : ''}">
          ${isOutOfStock ? '<div class="stock-badge" style="position: absolute; top: 10px; right: 10px;">Out of Stock</div>' : ''}
        </div>
      ...
      <div class="product-detail-info">
        ...
        ${isOutOfStock ? '<div style="color: #e74c3c; font-size: 1rem; font-weight: 600; margin-bottom: 1rem;">⚠️ This product is currently out of stock</div>' : ''}
        ...
        <div class="product-detail-actions">
          <button class="btn btn-outline" onclick="addToCartFromDetail(${product.id})" ${isOutOfStock ? 'disabled style="opacity: 0.5; cursor: not-allowed;"' : ''}>
          ...
          <button class="btn btn-primary" onclick="buyNow(${product.id})" ${isOutOfStock ? 'disabled style="opacity: 0.5; cursor: not-allowed;"' : ''}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
